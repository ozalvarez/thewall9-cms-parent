...
namespace thewall9.web.parent.Result
{
    ...
    public class RssResult : ActionResult
    {
        ...
        public override void ExecuteResult(ActionContext context)
        {
            ...
            using (XmlWriter _writer = XmlWriter.Create(context.HttpContext.Response.Body, settings))
            {
                ...
                _writer.WriteElementString("link", context.HttpContext.Request.Host.Value);
                ...
                _items.ForEach(x =>
                {
                    ...
                    _writer.WriteElementString("link", context.HttpContext.Request.Host.Value + "/post/" + x.BlogPostID + "/" + x.FriendlyUrl);
